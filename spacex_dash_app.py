...
app.layout = html.Div(children=[
    ...
    dcc.RangeSlider(
        ...
        marks={0: '0', 10000: '10000'},  # Marking for slider values
...
def render_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(values=[success_count, failed_count], names=['Success', 'Failed'], title=f'Success vs. Failed Launches for {selected_site}')
    return fig
